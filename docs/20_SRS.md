...
- 本ツールの動作前提マシン（物理メモリ 62.72GB + スワップ 48GB、詳細は [01_environment.md](01_environment.md)）で動作すること
...
- [01_environment.md](01_environment.md) に定めるマシンスペック（物理メモリ 62.72GB 等）と同等以上の環境で動作すること（01_environment.md に定めるスペックが最低動作条件。それ未満の環境での動作は非保証）
