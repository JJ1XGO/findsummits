...
- 主要更新箇所: 3.2 主要コンポーネント構成, 3.3 フェーズ俯瞰, [FR-009](../20_SRS.md#fr-009-sotaリスト突合match_status-判定) 入出力テーブル・説明, [FR-013](../20_SRS.md#fr-013-html-ビューア生成), [FR-014](../20_SRS.md#fr-014-広域結合解析オーケストレーション), 7.2 内部データ一覧 等。
